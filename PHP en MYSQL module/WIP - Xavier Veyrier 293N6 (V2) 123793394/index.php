...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    ...
    if (isset($_POST["add_member"])) {   
        ...
        insertContactDetails($conn, $telnrs, 'telefoonnummers');
        insertContactDetails($conn, $emails, 'emails');
            ...
            <form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST">
                ...
                <label for="postcode">
                    ...
                    <select name="postcode" required>
                        <option disabled selected value="<?php $postcode_result['postcode'] ?>">
                ...
                <label for="emailadres">
                    E-mailadres(sen):
                    <textarea name="emailadres" cols="45" rows="4">
                        <?php
